...
if(!isset($_SESSION['user_email'])){
  header("location: signin.php");
              ...
              $row_user = mysqli_fetch_array($run_user);
                    ...
                    echo "<script>window.open('./material/mec1.php','_self')</script>";}

                    elseif($user_dept == "Electronic and Electrical Engineering"){
                    echo "<script>window.open('v./material/EEE1.php','_self')</script>"; }

                        elseif($user_dept == "Civil Engineering"){
    echo "<script>window.open('./material/civil1.php','_self')</script>";}
                    elseif($user_dept == "Computer Engineering"){
                        echo "<script>window.open('./material/comp1.php','_self')</script>";}
